              ...
              child: ElevatedButton(
                onPressed: () {
                  if (cartNotEmpty) {
                    ...
                    alert(context, const Text("Cảnh báo"),
                        const Text("Chưa có sản phẩn nào được chọn"), [
                      TextButton(
                          onPressed: () {
                            context.pop();
                          },
                ...
                style: ElevatedButton.styleFrom(
                    ...
                    backgroundColor: (cartNotEmpty)
                        ? colorMain
                        : const Color.fromARGB(255, 87, 87, 91),
                ...
                child: ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => const LayoutGeneratePdfInvoice(),
                      ),
                    );
                  },
                  style: ElevatedButton.styleFrom(
